"""Stack-aware `doctor` for awbrain.
...
interesting failures live BETWEEN them. "awbrain is installed" is not the useful
fact -- "awbrain is installed and the thing it pairs with is not" is. This reports
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWBRAIN_CHAT_MODEL', 'AWBRAIN_CHAT_URL', 'AWBRAIN_EMBED_URL']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awbrain needs at runtime, and a
